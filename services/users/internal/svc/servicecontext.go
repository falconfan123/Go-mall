...
func NewServiceContext(c config.Config) *ServiceContext {
	// 初始化仓储
	userRepo := persistence.NewUserRepositoryImpl(user.NewUsersModel(sqlx.NewMysql(c.Mysql.DataSource)))
	...
	return &ServiceContext{
		Config:            c,
		UsersModel:        user.NewUsersModel(sqlx.NewMysql(c.Mysql.DataSource)),
		UserAddressesModel: user_address.NewUserAddressesModel(sqlx.NewMysql(c.Mysql.DataSource), c.Cache),
...
func (n *NoopEventPublisher) PublishUserRegistered(e *domainevent.UserRegisteredEvent) error { return nil }
func (n *NoopEventPublisher) PublishUserLoggedIn(e *domainevent.UserLoggedInEvent) error { return nil }
func (n *NoopEventPublisher) PublishUserLoggedOut(e *domainevent.UserLoggedOutEvent) error { return nil }
func (n *NoopEventPublisher) PublishUserInfoUpdated(e *domainevent.UserInfoUpdatedEvent) error { return nil }
func (n *NoopEventPublisher) PublishAddressAdded(e *domainevent.AddressAddedEvent) error { return nil }
func (n *NoopEventPublisher) PublishAddressUpdated(e *domainevent.AddressUpdatedEvent) error { return nil }
func (n *NoopEventPublisher) PublishAddressDeleted(e *domainevent.AddressDeletedEvent) error { return nil }
