...
const (
	Audit_CreateAuditLog_FullMethodName = "/audit.Audit/CreateAuditLog"
)
...
func (c *auditClient) CreateAuditLog(ctx context.Context, in *CreateAuditLogReq, opts ...grpc.CallOption) (*CreateAuditLogRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateAuditLogRes)
	err := c.cc.Invoke(ctx, Audit_CreateAuditLog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuditServer interface {
	// CreateAuditLog 创建审计日志
	CreateAuditLog(context.Context, *CreateAuditLogReq) (*CreateAuditLogRes, error)
...
func (UnimplementedAuditServer) CreateAuditLog(context.Context, *CreateAuditLogReq) (*CreateAuditLogRes, error) {
...
func _Audit_CreateAuditLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateAuditLogReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuditServer).CreateAuditLog(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Audit_CreateAuditLog_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuditServer).CreateAuditLog(ctx, req.(*CreateAuditLogReq))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Audit_CreateAuditLog_Handler,
		},
	},
