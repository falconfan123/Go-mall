...
const (
	...
	ProductCatalogService_GetUploadURL_FullMethodName     = "/product.ProductCatalogService/GetUploadURL"
...
func (c *productCatalogServiceClient) GetUploadURL(ctx context.Context, in *GetUploadURLReq, opts ...grpc.CallOption) (*GetUploadURLResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUploadURLResp)
	err := c.cc.Invoke(ctx, ProductCatalogService_GetUploadURL_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProductCatalogServiceServer) GetAllProduct(context.Context, *GetAllProductsReq) (*GetAllProductsResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAllProduct not implemented")
}
func (UnimplementedProductCatalogServiceServer) IsExistProduct(context.Context, *IsExistProductReq) (*IsExistProductResp, error) {
	return nil, status.Error(codes.Unimplemented, "method IsExistProduct not implemented")
}
func (UnimplementedProductCatalogServiceServer) QueryProduct(context.Context, *QueryProductReq) (*GetAllProductsResp, error) {
	return nil, status.Error(codes.Unimplemented, "method QueryProduct not implemented")
}
func (UnimplementedProductCatalogServiceServer) RecommendProduct(context.Context, *RecommendProductReq) (*GetAllProductsResp, error) {
	return nil, status.Error(codes.Unimplemented, "method RecommendProduct not implemented")
}
func (UnimplementedProductCatalogServiceServer) GetUploadURL(context.Context, *GetUploadURLReq) (*GetUploadURLResp, error) {
...
func _ProductCatalogService_GetUploadURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUploadURLReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductCatalogServiceServer).GetUploadURL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductCatalogService_GetUploadURL_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductCatalogServiceServer).GetUploadURL(ctx, req.(*GetUploadURLReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductCatalogService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProductCatalogService_GetUploadURL_Handler,
		},
		{
