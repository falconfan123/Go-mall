...
type TimeResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Now           int64                  `protobuf:"varint,1,opt,name=now,proto3" json:"now,omitempty"` // 服务器当前 Unix 时间戳（毫秒）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_system_proto_rawDesc = "" +
	...
	"\aTimeReq\"\x1c\n" +
	"\bTimeResp\x12\x10\n" +
	"\x03now\x18\x01 \x01(\x03R\x03now23\n" +
	"\x06System\x12)\n" +
	"\x04Time\x12\x0f.system.TimeReq\x1a\x10.system.TimeRespB\x06Z\x04./pbb\x06proto3"
...
var file_system_proto_goTypes = []any{
	(*TimeReq)(nil),  // 0: system.TimeReq
	(*TimeResp)(nil), // 1: system.TimeResp
}
var file_system_proto_depIdxs = []int32{
	0, // 0: system.System.Time:input_type -> system.TimeReq
	1, // 1: system.System.Time:output_type -> system.TimeResp
