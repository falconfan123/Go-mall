...
type (
	userAddressesModel interface {
		...
		FindOne(ctx context.Context, addressId uint64) (*UserAddresses, error)
...
func (m *defaultUserAddressesModel) Delete(ctx context.Context, addressId uint64) error {
...
func (m *defaultUserAddressesModel) FindOne(ctx context.Context, addressId uint64) (*UserAddresses, error) {
	userAddressesAddressIdKey := fmt.Sprintf("%s%v", cacheUserAddressesAddressIdPrefix, addressId)
